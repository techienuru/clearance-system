            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="container mt-5">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="welcome-card shadow-lg p-5 rounded">
                        <h1 class="display-4">
                          Welcome, <span id="student-name"><?php echo $object->student_fullname; ?></span>!
                        </h1>
                        <p class="lead">Your clearance process is now easier. Track your progress and download your clearance letter once approved.</p>
                        <a href="./clearance_status.php" class="btn btn-primary btn-lg mt-4">View Clearance Status</a>
                      </div>
                    </div>
                  </div>
                </div>
