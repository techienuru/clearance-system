    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-0">Your clearance is pending with the Dean's Office.</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-0">Your clearance has been approved by the Library.</p>
        ...
        <div class="card">
            <div class="card-header">
                Admin Office Clearance
            </div>
            <div class="card-body">
                <p class="mb-0">Your clearance has been rejected by the Faculty Office due to missing documents.</p>
