  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      ...
      <div class="container-fluid py-4">
          ...
          <div class="col-xl-12 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              <div class="card-body p-3">
                ...
                <div class="container clearance-container">
        <h2 class="text-center mb-4">Clearance Summary</h2>
        ...
        <!-- Clearance Status for Different Offices -->
        <div class="clearance-status">
            <!-- Dean's Office -->
            <div class="status">
                <h6>Dean's Office Clearance</h6>
                <span class="badge badge-approved">Approved</span>
            </div>
            <!-- Library -->
            <div class="status">
                <h6>Library Clearance</h6>
                <span class="badge badge-approved">Approved</span>
            </div>
            <!-- Faculty Office -->
            <div class="status">
                <h6>Faculty Office Clearance</h6>
                <span class="badge badge-pending">Pending</span>
            </div>
            <!-- Admin Block -->
            <div class="status">
                <h6>Admin Block Clearance</h6>
                <span class="badge badge-approved">Approved</span>
            </div>
        </div>
