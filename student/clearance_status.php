...
.clearance-step .badge {
    font-size: 1rem;
    padding: 0.6rem 1rem;
    border-radius: 50px;
}

.clearance-step .progress {
    height: 1rem;
    background-color: #e9ecef;
    border-radius: 12px;
}

.clearance-step .progress-bar {
    height: 100%;
    border-radius: 12px;
}
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      ...
      >
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./clearance_status.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
              ...
              <span class="nav-link-text ms-1">clearance Status</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./clearance_form.php">
              <div
                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
              >
                <svg
    ...
    >
      ...
      <div class="container-fluid py-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="clearance-status-card shadow-lg p-4 rounded">
                    <h2 class="mb-4">Clearance Status</h2>
                    
                    <!-- Clearance Step: Dean -->
                    <div class="clearance-step">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Department Approval</h5>
                    ...
                    <!-- Clearance Step: Librarian -->
                    <div class="clearance-step">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Faculty Approval</h5>
                    ...
                    <!-- Clearance Step: Bursar -->
                    <div class="clearance-step">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Admin's Approval</h5>
                    ...
                    <div class="text-center mt-4">
                        <a href="./download_letter.php" class="btn btn-primary btn-lg">Download Clearance Letter</a>
                    </div>
                </div>
            </div>
        </div>
