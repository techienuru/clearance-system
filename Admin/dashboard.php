            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="container welcome-container">
                  ...
                  <p class="sub-message">You can manage Officers and Students seamlessly here.</p>
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="task-card p-4">
                        ...
                        <h3 class="task-title">Manage Officers</h3>
                        <p class="task-description">Add, edit, and manage clearance officers across various departments and faculties.</p>
                        <a href="./manage_officers.php" class="btn action-btn">Go to Manage Officers</a>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="task-card p-4">
                        ...
                        <h3 class="task-title">Manage Students</h3>
                        <p class="task-description">Oversee student profiles, clearance status, and make adjustments as necessary.</p>
                        <a href="./manage_students.php" class="btn action-btn">Go to Manage Students</a>
                      </div>
                    </div>
                  </div>
                </div>
