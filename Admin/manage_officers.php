...
$object = new manage_officers($connect);

$object->collectUserID();

# If User adds an Officer
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./faculty_department.php">
            ...
            <span class="nav-link-text ms-1">Manage Faculty/Department</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Manage Officers</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
                ...
                <div class="container">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form id="add-officer-form" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
                        <div class="form-group">
                          <label for="faculty">Select Role</label>
                          <select class="form-control" name="role_id" id="faculty" required>
                            <option value="" disabled selected>Select Role</option>
                            <?php
                            $sql = $object->selectRoles();
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="officer_name" id="officer-name" placeholder="Enter Officer Name" required>
                        </div>
                        <div class="form-group">
                          <label for="officer-email">Email</label>
                          <input type="text" class="form-control" name="officer_email" id="officer-email" placeholder="Enter Officer Email" required>
                        </div>
                        <div class="form-group">
                          <label for="officer-password">Password</label>
                          <input type="password" class="form-control" name="officer_password" id="officer-password" placeholder="Enter Password" required>
                        </div>
                  ...
                  <div class="officer-card">
                    ...
                    <div class="officer-card">
                      <?php
                      $sql = $object->selectOfficers();
                      while ($row = $sql->fetch_assoc()) {
                      ?>
                        <div class="officer-row">
                          <div class="row">
                            <div class="col-md-4"><?php echo $row["fullname"]; ?></div>
                            <div class="col-md-4"><?php echo $row["role_name"]; ?></div>
                            <div class="col-md-4 text-right">
                              <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
                                <input type="hidden" name="officer_id" value="<?php echo $row["admin_id"]; ?>">
