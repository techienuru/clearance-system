...
$object = new manage_facult_department($connect);

$object->collectUserID();

# If User adds a Faculty
if (isset($_POST["add_faculty"])) {
  $object->collectFormInputs("faculty_name");
  $object->insertFacultyIntoDB();
}

# If User deletes a Faculty
if (isset($_POST["delete_faculty"])) {
  $object->deleteFaculty();
}

# If User adds a Department
if (isset($_POST["add_department"])) {
  $object->collectFormInputs("department_name");
  $object->insertDepartmentIntoDB();
}

# If User deletes a Department
if (isset($_POST["delete_department"])) {
  $object->deleteDepartment();
}
?>
    ...
    <nav
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Manage Faculty/Department</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="container">
                  <h2 class="text-center">Manage Faculty/Department</h2>

                  <!-- Add Faculty Section -->
                  <div class="faculty-card">
                    <h5>Add Faculty</h5>
                    <form id="add-faculty-form" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
                      <div class="form-group">
                        <label for="faculty-name">Faculty Name</label>
                        <input type="text" class="form-control" name="faculty_name" id="faculty-name" placeholder="Enter Faculty Name" required>
                      </div>
                      <button type="submit" name="add_faculty" class="btn btn-custom">Add Faculty</button>
                    </form>
                  </div>
                  ...
                  <div class="faculty-list">
                    ...
                    <?php
                    $sql = $object->selectFaculties();
                    while ($row = $sql->fetch_assoc()) {
                    ?>
                      <div class="faculty-row">
                        <div class="row">
                          <div class="col-md-10"><?php echo $row["faculty_name"]; ?></div>
                          <div class="col-md-2 text-right">
                  ...
                  <div class="department-card" style="margin-top: 30px;">
                    <h5>Add Department</h5>
                    <form id="add-department-form" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
                      <div class="form-group">
                        <label for="department-name">Department Name</label>
                        <input type="text" class="form-control" name="department_name" id="department-name" placeholder="Enter Department Name" required>
                      </div>
                      <div class="form-group">
                        <label for="department-name">Faculty</label>
                        <select name="faculty_id" id="faculty-id" class="form-control" required>
                  ...
                  <div class="department-list">
                    ...
                    ?>
                      <div class="department-row">
                        <div class="row">
                          <div class="col-md-5"><?php echo $row["department_name"] ?></div>
