                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                      <div class="welcome-card text-center">
                        <h1>Welcome, <?php echo $object->fullname; ?>!</h1>
                        <p>You are logged into your <?php echo $object->role_name; ?> dashboard. Here, you can manage the clearance requirements for students and review their submitted documents.</p>
                        <p>Your role is crucial in ensuring a smooth clearance process for the students assigned to your department, faculty, or administrative block.</p>
                        <a href="./add_requirements.php" class="btn">Add/Update Requirements</a>
                        <a href="./pending_clearance.php" class="btn">Review Submitted Documents</a>
                      </div>
                    </div>
                  </div>
                </div>
