...
$object = new pending_clearance($connect);
            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="container clearance-page">
                  <h2 class="text-center mb-4">List of Pending Students</h2>
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php
                        $sql = $object->selectSubmittedDocumentsList();
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $object->fetchDepartmentName($row["department_id"]); ?></td>
                            <td>
                              <a href="./submitted_document.php?student_id=<?php echo $row["student_id"]; ?>" class="btn btn-view">View Details</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
